(function e(t, n) {
	...
	else if (typeof exports === 'object') exports['SwupPlugin'] = n();
	else t['SwupPlugin'] = n();
})(window, function() {
	return (function(e) {
		var t = {};
		...
		n.d = function(e, t, o) {
			if (!n.o(e, t)) {
				Object.defineProperty(e, t, { configurable: false, enumerable: true, get: o });
			}
		};
		n.r = function(e) {
					...
					},
					{
						...
						value: function e(t, n) {
							...
							i.forEach(function(e) {
								o._classNameAddedToElements.push(e);
								e.classList.add('swup-transition-' + n);
							});
						}
					}
				]);
